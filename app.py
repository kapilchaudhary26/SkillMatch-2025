...
st.title(':red[SKILLMATCH:-] :rainbow[AI Assisted Skill Matching Tool]')
st.markdown('#### This application will match and analyze your resume and the job discription provided')
tips = '''
Follow these steps:-
1. Upload your resume (pdf only) in side bar.
2. Copy and paste the job description below.
3. Click in submit to run the application.'''
st.write(tips)
